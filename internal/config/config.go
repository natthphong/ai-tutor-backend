...
func Load() (Config, error) {
	c := Config{Port: "8080", AudioDir: "./data/audio", PublicURL: "http://localhost:8080", Origins: []string{"http://localhost:3000"}, Version: "2026-09-05.2", PriceDate: "2026-09-05", USDTHB: 35, MonthlyBudget: 600, LiveMinutes: 10, RetentionDays: 30, Voice: "Kore", TimeoutSeconds: 45, Models: map[string]Model{
